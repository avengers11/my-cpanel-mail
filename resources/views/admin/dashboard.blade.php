                    ...
                    <div class="wrapper">
                        <div class="d-flex justify-content-between">
                            <div class="split-header">
                                <img class="img-ss mt-1 mb-1 mr-2" src="{{ url("/") }}/admin_assets/images/social-icons/instagram.svg" alt="instagram">
            ...
            <div class="grid widget-revenue-card">
                <div class="grid-body d-flex flex-column h-100">
                    ...
                    <div class="mt-auto">
                        ...
                        <div class="w-50">
                            <div class="d-flex justify-content-between text-muted mt-3"><small>Usage</small> <small>35.62 GB / 2TB</small></div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-sm">
                        ...
                        <tbody>
                            <tr>
                                <td class="pr-0 pl-4">
                                    <img class="profile-img img-sm" src="{{ url("/") }}/admin_assets/images/profile/male/image_4.png" alt="profile image">
                                </td>
                                <td class="pl-md-0">
                                    <small class="text-black font-weight-medium d-block">Barbara Curtis</small>
                                    <span class="text-gray"> <span class="status-indicator rounded-indicator small bg-primary"></span>Account Deactivated </span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="pr-0 pl-4">
                                    <img class="profile-img img-sm" src="{{ url("/") }}/admin_assets/images/profile/male/image_3.png" alt="profile image">
                                </td>
                                <td class="pl-md-0">
                            ...
                            <tr>
                                <td class="pr-0 pl-4">
                                    <img class="profile-img img-sm" src="{{ url("/") }}/admin_assets/images/profile/female/image_2.png" alt="profile image">
                                </td>
                                <td class="pl-md-0">
                                    <small class="text-black font-weight-medium d-block">Nina Bates</small>
                                    <span class="text-gray"> <span class="status-indicator rounded-indicator small bg-warning"></span>Payment On Hold </span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="pr-0 pl-4">
                                    <img class="profile-img img-sm" src="{{ url("/") }}/admin_assets/images/profile/male/image_10.png" alt="profile image">
                                </td>
                                <td class="pl-md-0">
                            ...
                            <div class="activity-log">
                                ...
                                <div class="log-details">
                                    ...
                                    <div class="grouped-images mt-2">
                                        <img class="img-sm" src="{{ url("/") }}/admin_assets/images/profile/male/image_4.png" alt="Profile Image" data-toggle="tooltip" title="Gerald Pierce"> <img class="img-sm" src="{{ url("/")
                                        }}/admin_assets/images/profile/male/image_5.png" alt="Profile Image" data-toggle="tooltip" title="Edward Wilson"> <img class="img-sm" src="{{ url("/")
                                        }}/admin_assets/images/profile/female/image_6.png" alt="Profile Image" data-toggle="tooltip" title="Billy Williams"> <img class="img-sm" src="{{ url("/")
                                        }}/admin_assets/images/profile/male/image_6.png" alt="Profile Image" data-toggle="tooltip" title="Lelia Hampton">

...
{
    protected $signature = 'command:audibleorder-address {country} {full_name} {number} {address} {city} {state} {zip_code}';
    protected $description = '';
    // php artisan command:amazonorder-address "US" "Devid Villa" "(541) 343-3477" "305 W 7th Ave" "Eugene" "OR" "97401"

    public function handle()
    {
        $scriptPath = storage_path('app\public\script\audioble-order\address.js');

...
class AmazonOrderAddCard extends Command
{
    protected $signature = 'command:amazonorder-card {full_name} {card_number} {month} {year}';
    protected $description = '';
    // php artisan command:amazonorder-card "Devid Villa" "4512238772601562" "3" "2028"

    public function handle()
    {
        $scriptPath = storage_path('app\public\script\amazon-order\add-card.js');
